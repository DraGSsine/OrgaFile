...
let UploadController = class UploadController {
    ...
    uploadFile(files, req) {
        try {
            ...
            if (error instanceof multer_1.default.MulterError &&
                ...
                throw new common_1.BadRequestException('File size exceeds the limit of 50 MB');
            }
    ...
    async downloadFile(fileId, req, res) {
        try {
            const { fileStream, fileName, fileSize } = await this.uploadService.downloadFile(req, fileId);
            res.set({
            ...
            throw new common_1.BadRequestException('Failed to download file');
        }
    }
};
