...
let AuthService = class AuthService {
    ...
    async generateTokens(userId, isSubscribed) {
        const accessToken = await this.jwtService.signAsync({ userId, isSubscribed }, { expiresIn: '7d', secret: process.env.JWT_SECRET_KEY });
        return accessToken;
    }
};
